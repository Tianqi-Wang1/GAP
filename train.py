...
def main(args):
    ...
    if args.eval_only:
        ...
        if args.analyze_gap:
            trainer.test()
            trainer.analyze_modality_gap(
                save_path=args.gap_save_path,
                energy=args.gap_energy,
                topk=args.gap_topk,
                center=args.gap_center,
            )
        else:
            trainer.test()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-dir", type=str, default="output/FINAL/debug/oxford_flowers/VIT_adapter_16shots_1.0_50_128_4_with/seed1", help="output directory")
    parser.add_argument(
        "--resume",
        type=str,
        default="",
    ...
    parser.add_argument(
        "--model-dir",
        type=str,
        default="output/FINAL/debug/oxford_flowers/VIT_adapter_16shots_1.0_50_128_4_with/seed1",
    ...
    parser.add_argument("--analyze_gap", default=True)
    parser.add_argument("--gap_save_path", type=str, default="output/FINAL/debug/oxford_flowers/VIT_adapter_16shots_1.0_50_128_8_with/seed1/modality_gap_ours.json")
    parser.add_argument("--gap_energy", type=float, default=0.95)
    parser.add_argument("--gap_topk", type=int, default=None)
    parser.add_argument("--gap_center", action="store_true")
    parser.add_argument("--gap_chunk_size", type=int, default=4096)
