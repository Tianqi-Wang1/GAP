...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.OrthComp_adapter.RESIDUAL_SCALE = 0.2
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-dir", type=str, default="output/FINAL/debug/food101/VIT_adapter_new/seed1", help="output directory")
    parser.add_argument(
        "--resume",
        type=str,
        default="",
    ...
    parser.add_argument(
        "--model-dir",
        type=str,
        default="output/FINAL/debug/food101/VIT_adapter_base_1.0_100_128_4_with/seed3",
