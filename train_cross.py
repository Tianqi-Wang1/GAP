...
def extend_cfg(cfg):
    ...
    # cfg.TRAINER.OrthComp_adapter.RESIDUAL_SCALE = 0.5
    ...
    # cfg.TRAINER.OrthComp_adapter.PB_COND_BASIS = "ref"
    ...
    cfg.TRAINER.OrthComp_adapter.TEXT_PROJ_RANK = 8
    ...
    cfg.TRAINER.OrthComp_adapter.report_residual_energy = True
    
    cfg.TRAINER.OrthComp_adapter.CROSS_DATASET_EVAL = True

    # 用于在 build_model 阶段读取 ImageNet source checkpoint 里的 B_T / B_Proj
    cfg.TRAINER.OrthComp_adapter.SOURCE_MODEL_DIR = ""
    cfg.TRAINER.OrthComp_adapter.SOURCE_LOAD_EPOCH = 50
...
def main(args):
    ...
    if args.eval_only:
        ...
        if hasattr(trainer, "report_residual_energy"):
            trainer.report_residual_energy()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-dir", type=str, default="output/FINAL/cg/ucf101/seed1", help="output directory")
    # imagenetv2, imagenet_sketch, imagenet_a_filter, imagenet_r_filter
    parser.add_argument(
        "--resume",
        type=str,
        default="",
    ...
    parser.add_argument(
        "--model-dir",
        type=str,
        default="output/FINAL/debug/imagenet/VIT_adapter_16shots_1.0_50_128_8_with/seed1",
