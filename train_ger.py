...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-dir", type=str, default="output/FINAL/dg/imagenetv2/seed1", help="output directory")
    ...
    parser.add_argument(
        "--dataset-config-file",
        type=str,
        default="configs/datasets/imagenetv2.yaml",
    ...
    parser.add_argument(
        "--model-dir",
        type=str,
        default="output/FINAL/debug/imagenet/VIT_adapter_16shots_1.0_50_128_8_with/seed3",
